...
public class Res extends RESTService {
  ...
  @SwaggerDefinition(
      info = @Info(title = "176", version = "0.0.0",
          ...
          license = @License(name = "BSD",
              url = "https://github.com/PhilCAEOrg2/microservice-176/blob/master/LICENSE.txt") ) )
  @Path("/")
  ...
  public Response method1(@PathParam("id") String id, String body) {
    ...
    // res1
    boolean res1_condition = true;
    if(res1_condition) {
      JSONObject res1 = new JSONObject();

      

      return Response.status(HttpURLConnection.HTTP_OK).entity(res1.toJSONString()).build();
    }
    // notfound
